#
#  Be sure to run `pod spec lint OTPBox.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "tuledev" => "tu.leanh@digitel.com.vn" }
  # Or just: spec.author    = "tuledev"
  # spec.authors            = { "tuledev" => "tu.leanh@digitel.com.vn" }
  # spec.social_media_url   = "https://twitter.com/tuledev"
